...
(() => {
  ...
  async function load() {
    ...
    // agents
    if (!r.agents.length) {
      $('#agentWall').innerHTML = `<div class="empty"><b>No agents in this wallet yet.</b>Build one and mint it; it lands here the moment Solana confirms it. <a class="btn sm" href="/#build" style="margin-top:12px">Build yours →</a></div>`;
